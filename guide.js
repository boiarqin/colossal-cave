...
var HelpMessage = "Here are some things you  can say: Give me an attraction. Tell me about " + location + ". Tell me the top five things to do. Tell me the local news.";
...
var startSearchHandlers = Alexa.CreateStateHandler(states.SEARCHMODE, {
    ...
    'getNewsIntent': function () {
        httpGet(location, function (response) {
            ...
            var cardContent = "Your " + location + " headlines by New York Times\n\n";
            ...
            if (responseData == null) {
                ...
                for (var i = 0; i < responseData.response.docs.length; i++) {
                    ...
                    if (i < numberOfResults) {
                        ...
                        console.log("Didn't explode yet: " + headline);
                        var index = i + 1;
...
var topFiveHandlers = Alexa.CreateStateHandler(states.TOPFIVE, {
    ...
    'getMoreInfoIntent': function () {
        ...
        if (selectedAttraction) {
            ...
            this.emit(':tell', noAttractionErrorMessage);
        }
    },
